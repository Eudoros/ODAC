...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 6011
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 6012
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 16011
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 16012
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 6011
	%{_sbindir}/semanage port -d -p tcp 6012
	%{_sbindir}/semanage port -d -p tcp 16011
	%{_sbindir}/semanage port -d -p tcp 16012
