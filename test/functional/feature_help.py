...
"""Verify that starting obsidiandigitalassetcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start obsidiandigitalassetcoin with -h for help text")
        ...
        self.log.info("Start obsidiandigitalassetcoin with -version for version information")
