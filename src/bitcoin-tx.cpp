...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s obsidiandigitalassetcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  obsidiandigitalassetcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded obsidiandigitalassetcoin transaction") + "\n" +
              "  obsidiandigitalassetcoin-tx [options] -create [commands]   " + _("Create hex-encoded obsidiandigitalassetcoin transaction") + "\n" +
              "\n";
