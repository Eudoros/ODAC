...
/* ObsidianDigitalAssetCoin: Disable RBF
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    /* ObsidianDigitalAssetCoin: Disabled RBF UI
...
void TestGUI()
{
    ...
    // ObsidianDigitalAssetCoin: Disable BumpFee tests
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: obsidiandigitalassetcoin:")) != -1);
